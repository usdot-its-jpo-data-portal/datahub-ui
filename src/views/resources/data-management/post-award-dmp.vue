  ...
  <div class="usa-layout-docs__main desktop:grid-col-9 usa-prose">
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <strong>License Used:</strong> List the license that is used for this/these dataset(s) (e.g. Creative Commons – BY version X.0) and provide a URL (or several) with more information on the license. Specify whether the license is an open license or a non-open license. An “’open license’ means a legal guarantee that a data asset is made available (A) at no cost to the public and (B) with no restrictions on copying publishing, distributing, transmitting, citing or adapting such asset. ”, definition referenced from <a target="_blank" href="https://www.congress.gov/bill/115th-congress/house-bill/1770/text">congress.gov's webpage for H.R.1770<img class="in-line-external-link-icon" src="/images/icons/external-tabs.svg" alt="New tab icon." title="Opens in a new tab."></a>, see SEC. 4. OPEN GOVERNMENT DATA.  A non-open license does not adhere to all of the open license criteria.  
        </li>
        <li>
