<template>
  <div class="usa-layout-docs__main desktop:grid-col-9 usa-prose">
    ...
    <ul>
      ...
      <li><a href="https://github.com/usdot-its-jpo-data-portal/data-access-coe-resources/raw/master/Post_Award_DMP_Template.docx">Post-Award DMP Template &mdash; Microsoft Word version<img class="in-line-external-link-icon" src="/images/icons/external-link_1b1b1b.svg" alt="External from DOT link icon" title="External link. Opens in a new tab."></a></li>
      <li><a href="https://github.com/usdot-its-jpo-data-portal/data-access-coe-resources/raw/master/Post_Award_DMP_Template.pdf">Post-Award DMP Template &mdash; Adobe PDF version<img class="in-line-external-link-icon" src="/images/icons/external-link_1b1b1b.svg" alt="External from DOT link icon" title="External link. Opens in a new tab."></a></li>
    </ul>
