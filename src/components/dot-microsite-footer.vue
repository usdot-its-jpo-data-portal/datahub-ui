        ...
        <div class="grid-row grid-gap cdh_usa-footer__secondary-section_inner-wrapper">
          ...
          <div class="grid-row tablet:grid-col-6 content right-column email-registration-wrapper">
            ...
            <div class="controls">
              ...
              <button type="button" class="btn btn-primary darkblue-button" v-on:click="signup()" id="btn_submit-email-address">Sign Up <img src="/images/icons/external-link_ffffff.svg" alt="External link icon"> </button>
            </div>
            </div>
          </div>
